...
Begin
	...
	begin try
		...
		insert into dbo.tf_po_proc(poCliente,	poNumber,	poVendorId,		poCompany,	poDetailId,		poLineNumber,	itemCode,	session,	f_insert)
							values(@poCliente,	@poNumber,	@poVendorId,	@poCompany,	@poDetailId,	@poLineNumber,	@itemCode,	@session,	getdate())
